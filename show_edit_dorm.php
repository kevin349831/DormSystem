...
if ($netime >= $etime) {
    ...
    $count = $db->exec("INSERT INTO `Dorm_record`(`Dorm_ID`, `Dorm_Start_Date`, `Dorm_End_Date`, `BedBed_ID`, `StudentStudent_ID`) VALUES (null,'$netime','$etime','$b_id','$sid')");
    ...
    <body bgcolor="#eee">
        <table align="center">
            ...
            <tr height="50"><td>離宿日期：</td><td>' . $etime . '</td></tr>
        </table>
